...
public class ReverseUtil {
	...
	public static List<String> fillTableList() {
		...
		tablesList.add("TACHIEVEMENT");
		tablesList.add("TAPPRAISAL");
		tablesList.add("TAPPRAISALTYPE");
		tablesList.add("TAPPROVAL");
		tablesList.add("TCOMMITMENT");
		tablesList.add("TCOMPETENCE");
		tablesList.add("TCONTRIBUTION");
		tablesList.add("TDEFINEDVALUES");
		tablesList.add("TEVALUATOR");
		tablesList.add("TFINALRATING");
		tablesList.add("THEADER");
		tablesList.add("TKNOWLEDGE");
		tablesList.add("TKNOWLEDGEITEMS");
		tablesList.add("TLANGUAGE");
		tablesList.add("TLEARNINGNEED");
		tablesList.add("TRATING");
		tablesList.add("TRECOMENDATIONITEMS");
		tablesList.add("TRECOMENDATIONS");
		tablesList.add("TRESULTS");
		tablesList.add("TSECTION");
		//tablesList.add("TSECTIONTEXT");
		tablesList.add("TSUBDEFINED");
		tablesList.add("TTOOLITEMS");
		tablesList.add("TTOOLS");

		/*
		TACHIEVEMENT, TAPPRAISAL , TAPPRAISALTYPE, TAPPROVAL, TCOMMITMENT, TCOMPETENCE, TCONTRIBUTION, TDEFINEDVALUES
		TEVALUATOR, TFINALRATING, THEADER, TKNOWLEDGE, TKNOWLEDGEITEMS, TLANGUAGE, TLEARNINGNEED, TRATING, TRECOMENDATIONITEMS
		TRECOMENDATIONS, TRESULTS, TSECTION, TSUBDEFINED, TTOOLITEMS, TTOOLS 
