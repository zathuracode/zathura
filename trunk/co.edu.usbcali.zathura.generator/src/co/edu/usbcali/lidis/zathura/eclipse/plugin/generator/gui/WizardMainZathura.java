...
public class WizardMainZathura extends Wizard {
	...
	public void addPages() {
		...
		// wizardGenerationProcessProgress=new
		// WizardGenerationProcessProgress();
	...
	public boolean performFinish() {
		try {
			...
			progressMonitorDialogReverseEngineering.run(true, true,
					new co.edu.usbcali.lidis.zathura.eclipse.plugin.generator.utilities.RunningGenerationReverseEngineering());
