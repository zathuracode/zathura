...
public interface IStringBuilder {
	...
	/**
	 * Gets the strings to entity for many to one properties.
	 *
	 * @param manyToOne the many to one
	 * @param theMetaData the meta data
	 * @return the strings to entity for many to one properties
	 */
	public List<String> getStringsToEntityForManyToOneProperties(List<Member> manyToOne, List<MetaData> theMetaData);

	/**
	 * Final param for dto for sets variables in list gwt.
	 *
	 * @param list the list
	 * @param metaData the meta data
	 * @return the list< string>
	 */
	public List<String> finalParamForDtoForSetsVariablesInListGWT(List<MetaData> list, MetaData metaData);
