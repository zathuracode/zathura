package co.edu.usbcali.lidis.zathura.jpareverse.test;
...
import co.edu.usbcali.lidis.zathura.jpareverse.engine.IZathuraJPAReverseEngineering;
import co.edu.usbcali.lidis.zathura.jpareverse.engine.ZathuraJPAReverseEngineering;
...
//		List<String> tablesList = null;
		...
		List<String> tablesList = JPAReverseEngineeringUtil.fillTableList();
