...
import co.edu.usbcali.lidis.zathura.generator.jeehibernatecorespringcentric.utils.IStringBuilder;
import co.edu.usbcali.lidis.zathura.generator.jeehibernatecorespringcentric.utils.IStringBuilderForId;
import co.edu.usbcali.lidis.zathura.generator.jeehibernatecorespringcentric.utils.StringBuilder;
import co.edu.usbcali.lidis.zathura.generator.jeehibernatecorespringcentric.utils.StringBuilderForId;
import co.edu.usbcali.lidis.zathura.generator.jeehibernatecorespringcentric.utils.Utilities;
...
public class ZathuraJavaEE_Web_Centric implements IZathuraGenerator,
	...
	private final static String springCentric = GeneratorUtil
			.getSpringWebCentricTemplates();
	...
	public void toGenerate(MetaDataModel metaDataModel, String projectName,
		...
		String domainName = propiedades.getProperty("domainName");
...
//		String generatorLibrariesZathuraJavaEESpringWebCentricJpaHibernate = GeneratorUtil
//				.getGeneratorExtZathuraJavaEESpringWebCentric()
//				+ GeneratorUtil.slash
//				+ "core-hibernate3.3"
//				+ GeneratorUtil.slash;
...
//				libFolderPath);
		...
		GeneratorUtil.copyFolder(generatorExtZathuraJavaEESpringWebCentricWEBXML,
