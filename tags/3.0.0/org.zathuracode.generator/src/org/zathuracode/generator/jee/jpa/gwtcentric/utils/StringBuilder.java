...
public class StringBuilder implements IStringBuilder {
		...
		if (metaData.isGetSimpleProperties()) {
			for (Member member : metaData.getSimpleProperties()) {
				if (member.isPrimiaryKeyAComposeKey() == false) {
					...
					if (member.getRealClassName().equalsIgnoreCase("date")) {
						finalParam = finalParam + "(txt" + member.getGetNameOfPrimaryName() + ".getValue())==null||(txt" + member.getGetNameOfPrimaryName()
								+ ".getValue()).equals(\"\")?null:" + "(" + member.getRealClassName() + ")txt" + member.getGetNameOfPrimaryName()
								+ ".getValue(), ";
					} else {
						finalParam = finalParam + "(txt" + member.getGetNameOfPrimaryName() + ".getValue())==null||(txt" + member.getGetNameOfPrimaryName()
								+ ".getValue()).equals(\"\")?null:new " + member.getRealClassName() + "(txt" + member.getGetNameOfPrimaryName()
								+ ".getValue().toString()), ";
					}
				}
			}
					...
					for (int i = 0; i < params.length; i++) {
						...
						if (tmpFinalParam != null) {
							...
							if (tmpFinalParam.equalsIgnoreCase("date")) {
								tmpFinalParam = "(txt" + tmp + ".getValue())==null||(txt" + tmp + ".getValue()).equals(\"\")?null:" + "(" + tmpFinalParam
										+ ")txt" + tmp + ".getValue(), ";
							} else {
								tmpFinalParam = "(txt" + tmp + ".getValue())==null||(txt" + tmp + ".getValue()).equals(\"\")?null:new " + tmpFinalParam
										+ "(txt" + tmp + ".getValue().toString()), ";
							}
			...
			for (Member member : manyToOne) {
				if (metaData1.getRealClassName().equalsIgnoreCase(member.getRealClassName())) {
					...
					if (metaData1.getPrimaryKey().isPrimiaryKeyAComposeKey()) {
						...
						finalParam.add(member.getRealClassName() + " " + member.getName() + "Class = logic" + member.getRealClassName() + cont + ".get"
								+ member.getRealClassName() + "(" + metaData1.getPrimaryKey().getRealClassVariableName() + "Class);");
						cont++;

					} else {
						finalParam.add(member.getRealClassName() + " " + member.getName() + "Class = logic" + member.getRealClassName() + cont + ".get"
								+ member.getRealClassName() + "(" + metaData1.getPrimaryKey().getName() + "_" + metaData1.getRealClassName() + ");");
						cont++;
			...
			for (Member member : manyToOne) {
				if (metaData1.getRealClassName().equalsIgnoreCase(member.getRealClassName())) {
					...
					if (metaData1.getPrimaryKey().isPrimiaryKeyAComposeKey()) {
						...
						finalParam.add(member.getRealClassName() + " " + member.getName() + "Class = BusinessDelegatorView.get" + member.getRealClassName()
								+ "(" + metaData1.getPrimaryKey().getRealClassVariableName() + "Class);");
						cont++;

					} else {
						finalParam.add(member.getRealClassName() + " " + member.getName() + "Class = BusinessDelegatorView.get" + member.getRealClassName()
								+ "(" + metaData1.getPrimaryKey().getName() + "_" + metaData1.getRealClassName() + ");");
						cont++;
	...
	/* (non-Javadoc)
	 * @see org.zathuracode.generator.jee.jpa.gwtcentric.utils.IStringBuilder#getStringsToEntityForManyToOneProperties(java.util.List, java.util.List)
	 */
	...
	/* (non-Javadoc)
	 * @see org.zathuracode.generator.jee.jpa.gwtcentric.utils.IStringBuilder#finalParamForDtoForSetsVariablesInListGWT(java.util.List, org.zathuracode.metadata.model.MetaData)
	 */
	@Override
