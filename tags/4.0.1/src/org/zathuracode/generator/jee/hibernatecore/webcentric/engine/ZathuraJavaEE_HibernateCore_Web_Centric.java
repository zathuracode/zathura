package org.zathuracode.generator.jee.hibernatecore.webcentric.engine;
...
import org.zathuracode.generator.jee.hibernatecore.webcentric.utils.StringBuilderForId;
import org.zathuracode.generator.jee.hibernatecore.webcentric.utils.Utilities;
 ...
 * @version 1.0
 */
public class ZathuraJavaEE_HibernateCore_Web_Centric implements IZathuraGenerator, IZathuraTemplate {
	...
	private void copyLibreriasExt() {
		...
		String generatorExtZathuraJavaEEHibernateCoreWebCentricImages = GeneratorUtil.getGeneratorExtZathuraJavaEEHibernateCoreWebCentric()
				+ GeneratorUtil.slash + "images" + GeneratorUtil.slash;
		String generatorExtZathuraJavaEEHibernateCoreWebCentricCSS = GeneratorUtil.getGeneratorExtZathuraJavaEEHibernateCoreWebCentric() + GeneratorUtil.slash
				+ "css" + GeneratorUtil.slash;
		String generatorExtZathuraJavaEEHibernateCoreWebCentricXmlhttp = GeneratorUtil.getGeneratorExtZathuraJavaEEHibernateCoreWebCentric()
				+ GeneratorUtil.slash + "xmlhttp" + GeneratorUtil.slash;
		String generatorExtZathuraJavaEEHibernateCoreWebCentricWEBXML = GeneratorUtil.getGeneratorExtZathuraJavaEEHibernateCoreWebCentric()
				+ GeneratorUtil.slash + "WEB-INF" + GeneratorUtil.slash;
		String generatorExtZathuraJavaEEHibernateCoreWebCentricLOG4J = GeneratorUtil.getGeneratorExtZathuraJavaEEHibernateCoreWebCentric()
				+ GeneratorUtil.slash + "log4j" + GeneratorUtil.slash;
		String generatorLibrariesZathuraJavaEEHibernateCoreWebCentricIceFaces = GeneratorUtil.getGeneratorLibrariesZathuraJavaEEHibernateCoreWebCentric()
		...
		GeneratorUtil.copyFolder(generatorExtZathuraJavaEEHibernateCoreWebCentricImages, webRootFolderPath + "images" + GeneratorUtil.slash);

		// Copy Ext css
		GeneratorUtil.createFolder(webRootFolderPath + "css");
		GeneratorUtil.copyFolder(generatorExtZathuraJavaEEHibernateCoreWebCentricCSS, webRootFolderPath + "css" + GeneratorUtil.slash);

		// Copy Ext xmlhttp
		GeneratorUtil.createFolder(webRootFolderPath + "xmlhttp");
		GeneratorUtil.copyFolder(generatorExtZathuraJavaEEHibernateCoreWebCentricXmlhttp, webRootFolderPath + "xmlhttp" + GeneratorUtil.slash);

		// Copy Ext index.jsp
		GeneratorUtil.copy(generatorExtZathuraJavaEEHibernateCoreWebCentricIndexJsp, webRootFolderPath + GeneratorUtil.slash + "index.jsp");

		// Copy Ext log4j
		String folderProjectPath = properties.getProperty("folderProjectPath");
		GeneratorUtil.copyFolder(generatorExtZathuraJavaEEHibernateCoreWebCentricLOG4J, folderProjectPath + GeneratorUtil.slash);

	}

	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doTemplate(java.lang.String, org.zathuracode.metadata.model.MetaDataModel, java.lang.String, java.lang.String, java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doLogicXMLHibernate(org.zathuracode.metadata.model.MetaData, org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel, java.lang.String)
	 */
	public void doLogicXMLHibernate(MetaData metaData, VelocityContext context, String hdLocation, MetaDataModel dataModel, String modelName) {
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doDto(org.zathuracode.metadata.model.MetaData, org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doUtilites(org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doExceptions(org.apache.velocity.VelocityContext, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doJsp(org.zathuracode.metadata.model.MetaData, org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doJspFacelets(org.apache.velocity.VelocityContext, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doBusinessDelegator(org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doDaoXMLHibernate(org.zathuracode.metadata.model.MetaData, org.apache.velocity.VelocityContext, java.lang.String)
	 */
	public void doDaoXMLHibernate(MetaData metaData, VelocityContext context, String hdLocation) {
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doXMLHibernateDaoFactory(org.zathuracode.metadata.model.MetaDataModel, org.apache.velocity.VelocityContext, java.lang.String)
	 */
	public void doXMLHibernateDaoFactory(MetaDataModel metaData, VelocityContext context, String hdLocation) {
		...
		try {
			...
			FileWriter fstream = new FileWriter(realLocation + "XMLHibernateDaoFactory.java");
			BufferedWriter out = new BufferedWriter(fstream);
			out.write(swDaoFactory.toString());
			// Close the output stream
			out.close();

			JalopyCodeFormatter.formatJavaCodeFile(realLocation + "XMLHibernateDaoFactory.java");
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doHibernateSessionFactory(org.zathuracode.metadata.model.MetaDataModel, org.apache.velocity.VelocityContext, java.lang.String)
	 */
	public void doHibernateSessionFactory(MetaDataModel dataModel, VelocityContext context, String hdLocation) {
		...
		try {
			...
			FileWriter fstream = new FileWriter(realLocation + "HibernateSessionFactory.java");
			BufferedWriter out = new BufferedWriter(fstream);
			out.write(swEntityManager.toString());
			// Close the output stream
			out.close();

			JalopyCodeFormatter.formatJavaCodeFile(realLocation + "HibernateSessionFactory.java");
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doJspInitialMenu(org.zathuracode.metadata.model.MetaDataModel, org.apache.velocity.VelocityContext, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.webcentric.engine.IZathuraTemplate#doFacesConfig(org.zathuracode.metadata.model.MetaDataModel, org.apache.velocity.VelocityContext, java.lang.String)
	 */
