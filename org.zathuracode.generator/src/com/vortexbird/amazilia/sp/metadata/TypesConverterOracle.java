...
public class TypesConverterOracle {
	...
	public static String parseJavaType(String OracleType) {
		String javaType = "";
		if (OracleType.equalsIgnoreCase("NUMBER") || OracleType.equalsIgnoreCase("NUMERIC") || OracleType.equalsIgnoreCase("LONG")) {
			javaType = "java.lang.Long";
		} else {
			if (OracleType.equalsIgnoreCase("VARCHAR2") || OracleType.equalsIgnoreCase("VARCHAR")) {
				javaType = "java.lang.String";
			} else {
				if (OracleType.equalsIgnoreCase("DATE") || OracleType.equalsIgnoreCase("TIMESTAMP")) {
					...
					if (OracleType.equalsIgnoreCase("CHAR")) {
						...
						if (OracleType.equalsIgnoreCase("FLOAT")) {
							...
							if (OracleType.equalsIgnoreCase("INTEGER") || OracleType.equalsIgnoreCase("INT")) {
								javaType = "int";
							} else {
			...
			if (strOracleType.equalsIgnoreCase("NUMBER")) {
				...
				if (strOracleType.equalsIgnoreCase("NUMERIC")) {
					...
					if (strOracleType.equalsIgnoreCase("NUMBER")) {
						...
						if (strOracleType.equalsIgnoreCase("VARCHAR2") || strOracleType.equalsIgnoreCase("VARCHAR")) {
							...
							if (strOracleType.equalsIgnoreCase("DATE")) {
								...
								if (strOracleType.equalsIgnoreCase("TIMESTAMP")) {
									...
									if (strOracleType.equalsIgnoreCase("CHAR")) {
										...
										if (strOracleType.equalsIgnoreCase("FLOAT")) {
											iRetorno = OracleTypes.FLOAT;
										} else {
											if (strOracleType.equalsIgnoreCase("INTEGER") || strOracleType.equalsIgnoreCase("INT")) {
												iRetorno = OracleTypes.INTEGER;
											} else {
												if (strOracleType.equalsIgnoreCase("DECIMAL")) {
													iRetorno = OracleTypes.DECIMAL;
												} else {
													if (strOracleType.equalsIgnoreCase("")) {
