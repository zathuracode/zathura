package org.zathuracode.generator.jee.hibernatecore.springcentric.engine;
...
import org.zathuracode.generator.jee.hibernatecore.springcentric.utils.StringBuilderForId;
import org.zathuracode.generator.jee.hibernatecore.springcentric.utils.Utilities;
...
public class ZathuraJavaEE_HibernateCore_Web_Spring_Centric implements IZathuraGenerator, IZathuraTemplate {
	...
	private void copyLibreriasExt() {
		...
		String generatorExtZathuraJavaEEWebCentricIndexJsp = GeneratorUtil.getGeneratorExtZathuraJavaEESpringWebCentric() + GeneratorUtil.slash + "index.jsp";
		
		String generatorExtZathuraJavaEESpringWebCentricImages = GeneratorUtil.getGeneratorExtZathuraJavaEESpringWebCentric() + GeneratorUtil.slash + "images"
				+ GeneratorUtil.slash;
		String generatorExtZathuraJavaEESpringWebCentricCSS = GeneratorUtil.getGeneratorExtZathuraJavaEESpringWebCentric() + GeneratorUtil.slash + "css"
				+ GeneratorUtil.slash;
		String generatorExtZathuraJavaEESpringWebCentricXmlhttp = GeneratorUtil.getGeneratorExtZathuraJavaEESpringWebCentric() + GeneratorUtil.slash
				+ "xmlhttp" + GeneratorUtil.slash;
		String generatorExtZathuraJavaEESpringWebCentricWEBXML = GeneratorUtil.getGeneratorExtZathuraJavaEESpringWebCentric() + GeneratorUtil.slash + "WEB-INF"
				+ GeneratorUtil.slash;
		String generatorExtZathuraJavaEESpringWebCentricLOG4J = GeneratorUtil.getGeneratorExtZathuraJavaEESpringWebCentric() + GeneratorUtil.slash + "log4j"
				+ GeneratorUtil.slash;

		String generatorLibrariesZathuraJavaEESpringWebCentricIceFaces = GeneratorUtil.getGeneratorLibrariesZathuraJavaEESpringWebCentric()
				+ GeneratorUtil.slash + "iceFaces1.8.1" + GeneratorUtil.slash;
		String generatorLibrariesZathuraJavaEESpringWebCentricHibernate = GeneratorUtil.getGeneratorLibrariesZathuraJavaEESpringWebCentric()
		...
		GeneratorUtil.copyFolder(generatorExtZathuraJavaEESpringWebCentricImages, webRootFolderPath + "images" + GeneratorUtil.slash);

		// Copy Ext css
		GeneratorUtil.createFolder(webRootFolderPath + "css");
		GeneratorUtil.copyFolder(generatorExtZathuraJavaEESpringWebCentricCSS, webRootFolderPath + "css" + GeneratorUtil.slash);

		// Copy Ext xmlhttp
		GeneratorUtil.createFolder(webRootFolderPath + "xmlhttp");
		GeneratorUtil.copyFolder(generatorExtZathuraJavaEESpringWebCentricXmlhttp, webRootFolderPath + "xmlhttp" + GeneratorUtil.slash);
		...
		GeneratorUtil.copyFolder(generatorExtZathuraJavaEESpringWebCentricLOG4J, folderProjectPath + GeneratorUtil.slash);

	}

	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doTemplate(java.lang.String, org.zathuracode.metadata.model.MetaDataModel, java.lang.String, java.lang.String, java.lang.Integer, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doSpringContextConfFiles(org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doLogicSpringXMLHibernate(org.zathuracode.metadata.model.MetaData, org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doDto(org.zathuracode.metadata.model.MetaData, org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doUtilites(org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel, java.lang.String)
	 *  aqui
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doJsp(org.zathuracode.metadata.model.MetaData, org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doBusinessDelegator(org.apache.velocity.VelocityContext, java.lang.String, org.zathuracode.metadata.model.MetaDataModel)
	 */
	public void doBusinessDelegator(VelocityContext context, String hdLocation, MetaDataModel dataModel) {
		...
		try {
			...
			iBusinessDelegator = ve.getTemplate("IBusinessDelegatorView.vm");
		} catch (ResourceNotFoundException rnfe) {
			// couldn't find the template
			rnfe.printStackTrace();
		} catch (ParseErrorException pee) {
		...
		try {
			...
			FileWriter fstream2 = new FileWriter(realLocation + "IBusinessDelegatorView" + ".java");
			BufferedWriter out2 = new BufferedWriter(fstream2);
			out2.write(swIbusinessDelegator.toString());
			out2.close();
			JalopyCodeFormatter.formatJavaCodeFile(realLocation + "IBusinessDelegatorView" + ".java");
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doDaoSpringXMLHibernate(org.zathuracode.metadata.model.MetaData, org.apache.velocity.VelocityContext, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doJspInitialMenu(org.zathuracode.metadata.model.MetaDataModel, org.apache.velocity.VelocityContext, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.vortexbird.amazilia.generator.jee.hibernatecore.springcentric.engine.IZathuraTemplate#doFacesConfig(org.zathuracode.metadata.model.MetaDataModel, org.apache.velocity.VelocityContext, java.lang.String)
	 */
