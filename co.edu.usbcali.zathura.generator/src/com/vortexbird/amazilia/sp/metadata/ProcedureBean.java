...
public class ProcedureBean
{
	...
	if (strProcedureName != null && iColumnCount > 0 && columnNames != null
		&& columnTypeNames != null)
	{
		...
		{
		    result.append("Column Name: " + columnNames.get(i)
			    + " -- Column Type Name: " + columnTypeNames.get(i)
			    + "\n");
		}
	    }
	    ...
	    {
		result
			.append("Arguments Count: " + iTotalArgumentsCount
				+ "\n");
		for (int j = 0; j < argumentsNames.size(); j++)
		{
		    result.append("In Argument Name: " + argumentsNames.get(j)
			    + " -- In Argument Type Name: "
