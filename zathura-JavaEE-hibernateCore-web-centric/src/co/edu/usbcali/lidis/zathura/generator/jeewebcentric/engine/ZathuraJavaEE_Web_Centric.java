...
import co.edu.usbcali.lidis.zathura.generator.jeewebcentric.utils.IStringBuilder;
import co.edu.usbcali.lidis.zathura.generator.jeewebcentric.utils.IStringBuilderForId;
import co.edu.usbcali.lidis.zathura.generator.jeewebcentric.utils.StringBuilder;
import co.edu.usbcali.lidis.zathura.generator.jeewebcentric.utils.StringBuilderForId;
import co.edu.usbcali.lidis.zathura.generator.jeewebcentric.utils.Utilities;
...
public class ZathuraJavaEE_Web_Centric implements IZathuraGenerator,
	...
	public void doLogicXMLHibernate(MetaData metaData, VelocityContext context,
		...
		try {
			...
			logic = Velocity.getTemplate("LogicXMLHibernate.vm");
	...
	public void doDaoXMLHibernate(MetaData metaData, VelocityContext context,
		...
		try {
			idao = Velocity.getTemplate("IDAO2XMLHibernate.vm");
			dao = Velocity.getTemplate("DAO2XMLHibernate.vm");
		} catch (ResourceNotFoundException rnfe) {
			rnfe.printStackTrace();
		} catch (ParseErrorException pee) {
			// syntax error: problem parsing the template
	...
	public void doXMLHibernateDaoFactory(MetaDataModel metaData, VelocityContext context,
		...
		try {
			daoFactory = Velocity.getTemplate("XMLHibernateDaoFactory.vm");
	...
	public void doHibernateSessionFactory(MetaDataModel dataModel,
		...
		try {
			entityManager = Velocity.getTemplate("HibernateSessionFactory.vm");
			// logic = Velocity.getTemplate("Logic.vm");
		} catch (ResourceNotFoundException rnfe) {
			// couldn't find the template
			rnfe.printStackTrace();
