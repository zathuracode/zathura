...
public class RunningGeneration implements IRunnableWithProgress {
	  ...
	  public void run(IProgressMonitor monitor) throws InvocationTargetException,InterruptedException {
		  	...
		  	monitor.beginTask("Generation in progress...",IProgressMonitor.UNKNOWN);
		    	try {
					EclipseUtil.generate();
					
					monitor.subTask("Refresh "+EclipseUtil.projectName+" project...");
						EclipseUtil.project.refreshLocal(IResource.DEPTH_INFINITE, monitor);
					monitor.subTask("Building "+EclipseUtil.projectName+" project...");
						EclipseUtil.project.build(IncrementalProjectBuilder.FULL_BUILD, monitor);
